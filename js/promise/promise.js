/**
 * origin: https://github.com/xieranmaya/blog/issues/3
 * 其中还有些没弄懂的地方 line68 -line86 这段有待理解
 * 加入了一些自己的注释
 */

  var Promise = (function() {
    
    // 为了更好的理解this的指向，特此增加标记
    var i = 1;
    ...
    Promise.prototype.then = function(onResolved, onRejected) {
      onResolved = typeof onResolved === 'function' ? onResolved : function(v){return v} // 2.2.7.3 
      onRejected = typeof onRejected === 'function' ? onRejected : function(r){throw r} // 2.2.7.4 
      var self = this
      var promise2
